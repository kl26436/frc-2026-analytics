        ...
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-4 md:gap-8 w-full justify-center">
            <div className="text-center flex-1">
              ...
              <p className="mt-1.5 text-xs text-redAlliance/70">Min: {matchup.redRP.scorePercentiles.p10.toFixed(0)} – Max: {matchup.redRP.scorePercentiles.p90.toFixed(0)}</p>
            ...
            <div className="text-center flex-1">
              ...
              <p className="mt-1.5 text-xs text-blueAlliance/70">Min: {matchup.blueRP.scorePercentiles.p10.toFixed(0)} – Max: {matchup.blueRP.scorePercentiles.p90.toFixed(0)}</p>
              <div className="flex items-center justify-center gap-1 mt-1">
